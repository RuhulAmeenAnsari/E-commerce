...
const Card = ({name , image , id , price}) => {
  ...
  return (
    <>
    <div className='w-[300px] max-w-[90%] h-[400px] bg-[#fffff0a] backdrop:blur-lg rounded-lg hover:scale-[102%] flex items-start justify-start flex-col p-[10px] cursor-pointer border-[1px] border-[#80808049]'>
